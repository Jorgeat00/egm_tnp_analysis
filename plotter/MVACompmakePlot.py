...
flag='../CMSSW_10_1_1/src/egm_tnp_analysis/results/withData/test_rf67/eta_pt/passMVAId%s'%wp #test_rf67
flag2='../CMSSW_10_1_1/src/egm_tnp_analysis/results/withData/test_rf67/eta_pt/pass%sId'%wp
...
for plot in results_dict:
    ...
    c1.SaveAs('./new_results/eff_%s_comp%s_MVA_afterApp_FR_2.png'%(plot.replace('.','p'), wp))
    c1.SaveAs('./new_results/eff_%s_comp%s_MVA_afterApp_FR_2.pdf'%(plot.replace('.','p'), wp))
