...
flags = {
    'passreco'   : 'Probe_isGlobal ==1 ',
}
#baseOutDir = 'results/muonreco_newbinning/'
baseOutDir = 'results/muonreco_alt_newbinning/'
...
biningDef = [
   ...
   { 'var' : 'abs(Probe_eta)' , 'type': 'float', 'bins': [0, 1.2, 2.4] },
  #{ 'var' : 'abs(Probe_eta)' , 'type': 'float', 'bins': [0, 0.9, 1.2, 2.4] },
   #{ 'var' : 'Probe_pt' , 'type': 'float', 'bins': [20,30,40,50,120] },
   #{ 'var' : 'Probe_pt' , 'type': 'float', 'bins': [30,40,50,60,80,120] },
   { 'var' : 'Probe_pt' , 'type': 'float', 'bins': [35,50,75,100,500] },
...
cutBase = "TnP_trigger && Tag_pt > 37 && abs(Tag_eta) < 2.4 && Tag_pfRelIso04_all < 0.15 && Probe_pt > 20 && abs(Probe_eta) < 2.4 && abs(Tag_dxy) < 0.05 && abs(Tag_dz) < 0.1 && Tag_isGenMatched && Probe_isStandalone==1"
...
tnpParAltSigFit = [
    ...
    #bin6
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[5.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[5,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[75.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.001, 0.001, 1]","peakF[90.0]",
    #bin2
    ...
    #bin2
    #"meanP[1.0,-5.0,5.0]","sigmaP[1,0.0,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[0.5,-0.5,5.0]",
    #"meanF[1.4,-5.0,5.0]","sigmaF[1,0.0,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[2.4,0.5,5.0]",
    #"acmsP[75.,50.,90.]","betaP[0.04,0.01,10.0]","gammaP[0.05, -0.01, 1]","peakP[93.0]",
    #"acmsF[75.,60.,80.]","betaF[0.06,0.03,0.08]","gammaF[0.02, 0.005, 1]","peakF[90.0]",
    #bin2
    ...
    #"acmsF[60.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    #bin3
    #"meanP[-0.3,-2.0,2.0]","sigmaP[0.2,0.01,5.0]","alphaP[2.0,0.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.01,6.0]","sosP[0.5,-0.1,1.0]",
    #"meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    #"acmsP[75.,30.,120.]","betaP[0.04,0.001,1.0]","gammaP[0.05, -0.1, 1.0]","peakP[92.0]",
    #"acmsF[60.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
]
...
tnpParAltBkgFit = [
    ...
    "alphaF[0.,-5.,5.]",
    #bin12
    #"meanP[0.0,-0.0,1.0]","sigmaP[0.5,0.0,1.0]",
    #"meanF[0.0,-0.0,1.0]","sigmaF[0.5,0.0,1.0]",
    #"alphaP[0.1,-1.0,1.]",
    #"alphaF[0.1,-1.0,1.]",
    #bin0
    #"meanP[0.0,-0.1,5.0]","sigmaP[2.5,0.5,5.0]",
    #"meanF[-1.5,-2.0,0.0]","sigmaF[-2.5,-3.0,0.0]",
    #"alphaP[0.1,-2.0,2.]",
    #"alphaF[0.1,-2.0,2.]",
    ]
