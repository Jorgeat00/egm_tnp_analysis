...
flags = {
    'passttH'         : '(Probe_conept > 10 && Probe_jetBTagDeepFlavB < 0.3093 && Probe_mvaTTH > 0.85   && Probe_tightCharge>=1)',
    }

#baseOutDir = 'results_medium/TnP_ttH_muon_2016_2lss/'
baseOutDir = 'finalresults/TnP_ttH_muon_2016_2lss/'
...
tnpParNomFit = [
    ...
    "meanP[1.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    "acmsP[50.,0.,70.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[50.,0.,70.]","betaF[0.05,0.01,0.08]","gammaF[0.1, -1, 2]","peakF[90.0]",
...
tnpParAltSigFit = [
    ...
    "meanP[0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[0.2,0.,1.0]",
    "meanF[-0.4,-1.0,1.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1.0,0.05,5.0]",
    "acmsP[60.,50.,100.]","betaP[0.05,0.0,0.1]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[80.,70.,110.]","betaF[0.01,0.0,0.08]","gammaF[0.01, -1, 1]","peakF[90.0]",
    ]
...
tnpParAltBkgFit = [
    ...
    #"alphaF[0.,-5.,5.]",
    #bin39
    "meanP[0.0,-2.0,2.0]","sigmaP[0.2,0.0,1.0]",
    "meanF[3.,2.0,4.0]","sigmaF[3.0,0.0,5.0]",
    "alphaP[0.,-1.,1.]",
    "alphaF[0.,-1.,1.]",
    ]
