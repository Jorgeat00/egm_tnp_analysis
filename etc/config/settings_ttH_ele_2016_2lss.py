...
flags = {
    ...
    'passttH'         : '(Probe_pt > 10 && (Probe_hoe<(0.10-0.00*(abs((Probe_deltaEtaSC) - (-Probe_eta))>1.479))) && (Probe_eInvMinusPInv>-0.04)&& (Probe_sieie<(0.011-(-0.019)*(abs((Probe_deltaEtaSC)-(-Probe_eta))>1.479))) && Probe_convVeto &&  Probe_jetBTagDeepFlavB < 0.3093 && Probe_lostHits == 0 && Probe_mvaTTH > 0.8 && Probe_tightCharge>=2)',
    }

#baseOutDir = 'results/TnP_ttH_ele_2016_2lss/'
baseOutDir = 'finalresults/TnP_ttH_ele_2016_2lss/'
...
import etc.inputs.tnpSampleDef_ttH_ele_2016 as tnpSamples
...
tnpParNomFit = [
    ...
    #bin14
    "meanP[0.2,-2.0,2.0]","sigmaP[0.5,0.1,5.0]",
    "meanF[0.2,-2.0,2.0]","sigmaF[0.5,0.2,1.0]",
    "acmsP[75.,50.,100.]","betaP[0.06,0.01,0.2]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[75.,50.,90.]","betaF[0.06,0.01,0.2]","gammaF[0.1, -2, 2]","peakF[90.0]",
]
...
tnpParAltBkgFit = [
    ...
    #"alphaF[0.,-5.,5.]",
    #bin14
    "meanP[0.2,-1.0,1.0]","sigmaP[0.5,0.1,5.0]",
    "meanF[0.2,-1.0,1.0]","sigmaF[0.5,0.1,5.0]",
    "alphaP[-1.,-5.,0.]",
    "alphaF[-1.,-5.,0.]",
    ]
