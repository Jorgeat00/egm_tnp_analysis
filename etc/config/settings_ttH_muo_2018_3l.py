...
flags = {
    'passttH'         : '(Probe_conept > 10 && Probe_jetBTagDeepFlavB < 0.2770 && Probe_mvaTTH > 0.85)',
    }

#baseOutDir = 'results_medium/TnP_ttH_muon_2018_3l/'
baseOutDir = 'finalresults/TnP_ttH_muon_2018_3l/'
#baseOutDir = 'test/TnP_ttH_muon_2018_3l/'
...
tnpParNomFit = [
    ...
    #"acmsP[80.,50.,100.]","betaP[0.05,0.0,0.08]","gammaP[0.08, -2, 2]","peakP[90.0]",
    #"acmsF[60.,30.,90.]","betaF[0.05,0.0,0.1]","gammaF[0.05, -1, 2]","peakF[90.0]",
    #bin1
    #"meanP[0.,-5.0,5.0]","sigmaP[0.5,0.,5.0]",
    #"meanF[0.,-5.0,5.0]","sigmaF[0.4,0.,5.0]",
...
tnpParAltSigFit = [
    ...
    #"meanP[-2.6,-5.0,5.0]","sigmaP[0.8,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[5.5,0.5,6.0]","sosP[1,0.5,5.0]",
    #"meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    #"acmsP[60.,50.,75.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    #"acmsF[60.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    ]
...
tnpParAltBkgFit = [
    ...
    "meanF[0.0,-2.0,2.0]","sigmaF[0.9,0.5,5.0]",
    "alphaP[0.,-5.,5.]",
    "alphaF[-0.1,-2.,1.]",
    ]
