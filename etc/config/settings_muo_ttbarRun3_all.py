...
#baseOutDir = 'results/muonrecoandtight_alt/'
#baseOutDir = 'results/muonrecoandtight_noalt/'
baseOutDir = 'results/muonrecoandtight_alt_effMC_newbinning/'
...
biningDef = [
  ...
  #{ 'var' : 'abs(Probe_eta)' , 'type': 'float', 'bins': [0, 0.9, 1.2, 2.4] },
   ...
   { 'var' : 'Probe_pt' , 'type': 'float', 'bins': [35,40,45,55,70,100,200] },
...
tnpParNomFit = [
    ...
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    "acmsP[60.,50.,200.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,50.,200.]","betaF[0.04,0.01,0.05]","gammaF[0.03, 0.02, 0.05]","peakF[90.0]",
    ]
