...
flags = {
    ...
    'passttH'         : '(Probe_pt > 10 && (Probe_hoe<(0.10-0.00*(abs((Probe_deltaEtaSC) - (-Probe_eta))>1.479))) && (Probe_eInvMinusPInv>-0.04)&& (Probe_sieie<(0.011-(-0.019)*(abs((Probe_deltaEtaSC)-(-Probe_eta))>1.479))) && Probe_convVeto &&  Probe_jetBTagDeepFlavB < 0.3033 && Probe_lostHits == 0 && Probe_mvaTTH > 0.8 && Probe_tightCharge>=2)',
    }

#baseOutDir = 'results/TnP_ttH_ele_2017_2lss/'
baseOutDir = 'finalresults/TnP_ttH_ele_2017_2lss/'
...
tnpParNomFit = [
    ...
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    "acmsP[90.,80.,110.]","betaP[0.05,0.01,0.2]","gammaP[0.1, -2, 2]","peakP[90.0]",
...
tnpParAltSigFit = [
    ...
    #bin39
    #"meanP[0.0,-5.0,5.0]","sigmaP[0.5,0.2,5.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    #"meanF[2.0,-5.0,10.0]","sigmaF[0.4,0.2,5.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    #"acmsP[90.,60.,120.]","betaP[0.05,0.01,0.2]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[60.,50.,120.]","betaF[0.05,0.01,0.1]","gammaF[0.1, -2, 2]","peakF[90.0]",
    #bin38
    "meanP[0.0,-5.0,5.0]","sigmaP[0.2,0.1,5.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[90.,60.,100.]","betaP[0.02,0.01,0.1]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[110.,50.,120.]","betaF[0.05,0.01,0.1]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
