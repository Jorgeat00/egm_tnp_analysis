...
flags = {
    ...
    'passttH'         : '(Probe_pt > 10 && (Probe_hoe<(0.10-0.00*(abs((Probe_deltaEtaSC) - (-Probe_eta))>1.479))) && (Probe_eInvMinusPInv>-0.04)&& (Probe_sieie<(0.011-(-0.019)*(abs((Probe_deltaEtaSC)-(-Probe_eta))>1.479))) && Probe_convVeto &&  Probe_jetBTagDeepFlavB < 0.2770 && Probe_lostHits == 0 && Probe_mvaTTH > 0.8 && Probe_tightCharge>=2)',
    }

#baseOutDir = 'results/TnP_ttH_ele_2018_2lss/'
baseOutDir = 'finalresults/TnP_ttH_ele_2018_2lss/'
...
tnpParAltSigFit = [
    ...
    #bin35
    "meanP[0.0,-5.0,5.0]","sigmaP[0.5,0.1,5.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.1,5.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
...
tnpParAltBkgFit = [
    ...
    #"alphaF[0.,-5.,5.]",
    #bin35
    "meanP[0.0,-1.0,1.0]","sigmaP[0.2,0.1,1.0]",
    "meanF[0.0,-1.0,1.0]","sigmaF[0.2,0.1,1.0]",
    "alphaP[0.,-1.,1.]",
    "alphaF[0.,-0.04,0.04]",
    ]
