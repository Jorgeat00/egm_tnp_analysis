...
import etc.inputs.tnpSampleDef_mvaTTH_ele as tnpSamples
...
biningDef = [
    ...
    #{ 'var' : 'Probe_deltaEtaSC - (-Probe_eta)' , 'type': 'float', 'bins': [-2.5,-2.0,-1.566,-1.444,-1.0,-0.5, 0, 0.5, 1.0, 1.444, 1.566, 2.0, 2.5] },
...
tnpParNomFit = [
    ...
    #"meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    #"acmsP[70.,50.,150.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[60.,50.,90.]","betaF[0.04,0.01,0.2]","gammaF[0.1, -1, 2]","peakF[90.0]",
    #bin46,47
    #"meanP[0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    #"acmsP[60.,50.,200.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[55.,50.,80.]","betaF[0.04,0.01,0.05]","gammaF[0.03, 0.02, 0.05]","peakF[90.0]",
    #bin00, 08 (not used)
    #"meanP[0.0,-5.0,5.0]","sigmaP[0.1,0.,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    #"acmsP[70.,50.,150.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[60.,50.,100.]","betaF[0.04,0.01,0.2]","gammaF[0.03, 0.02, 1]","peakF[90.0]",
    #bin53 0.595
    #"meanP[0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[1.5,0.2,5.0]",
    #"acmsP[30.,10.,200.]","betaP[0.3,0.01,0.4]","gammaP[-0.1, -2, 2]","peakP[90.0]",
    #"acmsF[30.,10.,80.]","betaF[0.1,0.01,0.2]","gammaF[0.05, 0.02, 0.4]","peakF[90.0]",
    
    #bin2
    #"meanP[0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.2,5.0]",
    #"acmsP[60.,50.,150.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[60.,50.,100.]","betaF[0.04,0.01,0.2]","gammaF[0.03, 0.02, 1]","peakF[80.0]",
...
tnpParAltSigFit = [
    ...
    #bin08
    "meanP[0.0,-5.0,3.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,3.0]","sigmaF[2,0.7,5.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[80.,50.,110.]","betaP[0.04,0.01,0.2]","gammaP[0.7, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,90.]","betaF[0.07,0.01,0.2]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
...
tnpParAltBkgFit = [
    ...
    #bin08
    "meanP[0.5,-1.0,1.0]","sigmaP[0.2,0.1,1.5]",
    "meanF[-0.2,-1.0,1.0]","sigmaF[0.2,0.1,1.5]",
    "alphaP[-0.2,-0.5,0.5]",
    "alphaF[1.1,-2.,2.]",
    #bin07
    #"meanP[0.5,-1.0,5.0]","sigmaP[0.2,0.1,2.0]",
    #"meanF[0.1,-1.0,1.0]","sigmaF[0.1,-1.0,1.0]",
    #"alphaP[-0.2,-0.5,0.5]",
    #"alphaF[0.0,-0.1,0.1]",
    #bin10
    #"meanP[-0.5,-1.0,1.0]","sigmaP[0.2,0.1,1.5]",
    ...
    #"meanF[0.14,-0.2,0.2]","sigmaF[0.9,0.1,1.0]",
    #"alphaP[0.9.,-1.,1.]",
    #"alphaF[0.09,-0.1,0.1]",
    ]
