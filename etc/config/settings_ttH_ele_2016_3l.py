...
flags = {
    ...
    'passttH'         : '(Probe_pt > 10 && (Probe_hoe<(0.10-0.00*(abs((Probe_deltaEtaSC) - (-Probe_eta))>1.479))) && (Probe_eInvMinusPInv>-0.04)&& (Probe_sieie<(0.011-(-0.019)*(abs((Probe_deltaEtaSC)-(-Probe_eta))>1.479))) && Probe_convVeto &&  Probe_jetBTagDeepFlavB < 0.3093 && Probe_lostHits == 0 && Probe_mvaTTH > 0.8)',
    }



#baseOutDir = 'results/TnP_ttH_ele_2016_3l/'
baseOutDir = 'finalresults/TnP_ttH_ele_2016_3l/'
...
tnpParNomFit = [
    ...
    #bin14
    "meanP[0.3,-5.0,5.0]","sigmaP[0.4,0.1,5.0]",
    "meanF[0.0,-5.0,5.0]","sigmaF[0.4,0.1,5.0]",
    "acmsP[80.,50.,90.]","betaP[0.08,0.01,0.5]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,50.,90.]","betaF[0.05,0.01,0.5]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
