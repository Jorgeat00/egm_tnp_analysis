...
flags = {
    'passttH'         : '(Probe_conept > 10 && Probe_jetBTagDeepFlavB < 0.3033 && Probe_mvaTTH > 0.85  && Probe_tightCharge>=1)',
    }

#baseOutDir = 'results_medium/TnP_ttH_muon_2017_2lss/'
baseOutDir = 'finalresults/TnP_ttH_muon_2017_2lss/'
