...
#december 4, 2023
    ...
    'passtight'    : '(Probe_conept > 10 && Probe_jetBTagDeepFlavB < 0.3196 && Probe_mvaTTHRun3 > 0.64  && Probe_mediumId==1 &&  Probe_tightCharge == 2)',
...
baseOutDir = 'results_mvaTTH_2023BPix_alldata/muons/'
...
import etc.inputs.tnpSampleDef_mvaTTH_muo_BPix as tnpSamples
...
tnpParNomFit = [
    ...
    #"meanF[0.8,-5.0,5.0]","sigmaF[0.9,0.2,5.0]",
    #"acmsP[60.,50.,115.]","betaP[0.04,0.01,0.08]","gammaP[-0.09, -2, 2]","peakP[90.0]",
    #"acmsF[60.,50.,120.]","betaF[0.02,0.01,0.2]","gammaF[0.05, -1, 2]","peakF[90.0]",
    
    
    #bin33
    #"meanP[0.3,-1.0,1.0]","sigmaP[0.6,-0.1,1.0]",
    #"meanF[0.3,-1.0,1.0]","sigmaF[0.4,0.1,2.0]",
    #"acmsP[70.,40.,90.]","betaP[0.8,0.001,1.]","gammaP[0.02, -0.2, 0.2]","peakP[90.0]",
    #"acmsF[60.,40.,100.]","betaF[0.15,0.001,0.2]","gammaF[0.1, -1, 1]","peakF[90.0]",
    #bin32
    ...
    #"meanP[-0.0,-4.0,2.0]","sigmaP[0.1,0.0,5.0]",
    #"meanF[0.0,-5.0,5.0]","sigmaF[0.2,0.0,1.0]",
    #"acmsP[60.,50.,100.]","betaP[0.001,0.0002,0.9]","gammaP[0.4, -1, 2]","peakP[90.0]",
    #"acmsF[50.,20.,120.]","betaF[0.001,0.0002,1.0]","gammaF[0.4, -1, 3]","peakF[88.0]",
    #bin2
    #"meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    ...
    #"acmsP[60.,50.,80.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    #"acmsF[20.,10.,90.]","betaF[0.05,0.01,0.1]","gammaF[0.1, -2, 2]","peakF[90.0]",
...
tnpParAltSigFit = [
    ...
    #bin35
    #"meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[3,0.5,5.0]",
    #"meanF[1.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[3.5,0.5,5.0]", #3
    #"acmsP[60.,50.,100.]","betaP[0.04,0.01,0.2]","gammaP[0.3, 0.005, 1]","peakP[90.0]",
    #"acmsF[60.,50.,100.]","betaF[0.04,0.01,0.2]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    #bin31
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[3,1.5,5.0]",
    "meanF[1.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[3.,0.5,5.0]", #3
    "acmsP[60.,50.,100.]","betaP[0.04,0.01,0.2]","gammaP[0.3, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,100.]","betaF[0.08,0.01,0.2]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
