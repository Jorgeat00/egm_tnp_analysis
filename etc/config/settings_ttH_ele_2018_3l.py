...
flags = {
    ...
    'passttH'         : '(Probe_pt > 10 && (Probe_hoe<(0.10-0.00*(abs((Probe_deltaEtaSC) - (-Probe_eta))>1.479))) && (Probe_eInvMinusPInv>-0.04)&& (Probe_sieie<(0.011-(-0.019)*(abs((Probe_deltaEtaSC)-(-Probe_eta))>1.479))) && Probe_convVeto &&  Probe_jetBTagDeepFlavB < 0.2770 && Probe_lostHits == 0 && Probe_mvaTTH > 0.8)',
    }

#baseOutDir = 'results/TnP_ttH_ele_2018_3l/'
baseOutDir = 'finalresults/TnP_ttH_ele_2018_3l/'
...
import etc.inputs.tnpSampleDef_ttH_ele_2018 as tnpSamples
...
tnpParNomFit = [
    ...
    #bin35
    "meanP[0.0,-2.,2.0]","sigmaP[1,0.2,5.0]",
    "meanF[0.0,-2.0,2.0]","sigmaF[0.9,0.2,5.0]",
    "acmsP[60.,50.,110.]","betaP[0.05,0.01,0.5]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,50.,110.]","betaF[0.05,0.01,0.09]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
...
tnpParAltSigFit = [
    ...
    #bin39
    "meanP[0.0,-5.0,5.0]","sigmaP[0.3,0.2,5.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    ...
    "acmsF[90.,50.,120.]","betaF[0.05,0.01,0.2]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
...
tnpParAltBkgFit = [
    ...
    "alphaF[0.,-5.,5.]",
    #bin35
    #"meanP[-0.0,-2.,2.0]","sigmaP[2.,0.5,5.0]",
    #"meanF[-0.0,-1.0,1.0]","sigmaF[2,0.5,5.0]",
    #"alphaP[0.,-0.1,0.1]",
    #"alphaF[0.,-0.1,0.1]",
    ]
