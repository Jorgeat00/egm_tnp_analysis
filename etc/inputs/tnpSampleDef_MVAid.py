...
test = {'DY' : tnpSample('DY',   dirtest + 'DY_*_merged.root', isMC = True, nEvts = -1),
        'data' : tnpSample('data', dirtest + '*_Run2022*_merged.root', lumi = 35.1)} #check lumi
=======
...
>>>>>>> 86fd3cb2bc4c684d2e687bac4c0819b277e73ec2
