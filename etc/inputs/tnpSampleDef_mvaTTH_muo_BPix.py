...
dirtest='/lustrefs/hdd_pool_dir/nanoAODv12/geq1l_2022Run3/mvaTTHSF_run3/TnP_ntuples/Muon/2023BPix/'
dirtest_data = '/lustrefs/hdd_pool_dir/nanoAODv12/geq1l_2022Run3/mvaTTHSF_run3/TnP_ntuples/Muon/2023BPix/allData/'
test = {'DY' : tnpSample('DY',   dirtest + 'MC/DYJetsToLL/*.root', isMC = True, nEvts = -1),
        'DYAlt' : tnpSample('DYAlt',   dirtest + 'MCalt_new/DYJetsToLL/*.root', isMC = True, nEvts = -1),
